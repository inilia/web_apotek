                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="bi bi-person-badge"></i> Admin </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="bi bi-person-arms-up"></i> Kasir</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="bi bi-people-fill"></i> Pelayanan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="bi bi-box-seam"></i> Gudang</a>
                                    </li>
                                </ul>
